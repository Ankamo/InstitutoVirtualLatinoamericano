    ...
    <main className="min-h-screen bg-slate-100 p-4 sm:p-6">
      ...
      <section className="grid gap-4 lg:grid-cols-[2fr_1fr]">
        ...
        <article className="rounded-xl bg-white p-4 shadow-sm">
          ...
          <div className="h-40 rounded border border-slate-200 bg-[linear-gradient(90deg,_#e0f2fe_0%,_#fff_100%)] p-2 text-sm text-slate-500">
      ...
      <section className="mt-6 rounded-xl bg-white p-4 shadow-sm">
        ...
        <div className="overflow-hidden rounded border border-amber-400">
          ...
          <div className="grid grid-cols-7 border-t border-slate-100 text-center text-xs font-semibold text-slate-600">
            <div>lun.</div>
            <div>mar.</div>
            <div>mié.</div>
            <div>jue.</div>
